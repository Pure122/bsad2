...
<body>
    ...
    <form action="reg_db.php" method="POST" >
        ...
        <div class="user-box">
                <input type="text" name="username" required="Username is required" class="">
        ...
        <div class="user-box">
                <input type="password" name="password" required="Password is required" minlength="8">
                <label>Password</label>
        </div>
        <div class="user-box">
                <input type="password" name="password2" required="Password is required" minlength="8">
      ...
      button.addEventListener("click", (e) => {
        ...
        <br>
        <p class="text-white">Already a member? <button onclick="window.location.href='login.php'" style="border: none; background:transparent; "class="text-white"><u>Sign in</u></button></p>
        </div>
    </form>
                </div>
            </div>
